...
* @see Functions::github.com/mattbryson/TouchSwipe-Jquery-Plugin
...
* $version: 1.2.5 	- Added support for testing swipes with mouse on desktop browser (thanks to Functions::github.com/joelhy)
*
...
* $version 1.6.7    - Added patch from Functions::github.com/mattbryson/TouchSwipe-Jquery-Plugin/issues/206 to fix memory leak
*
	...
	_gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin","TweenLite"], function(TweenPlugin, TweenLite) {
		...
		var _transformProps = ("scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent").split(","),
			...
			_canGetBBox = function(e) {
				try {
					return e.getBBox(); //Firefox throws errors if you try calling getBBox() on an SVG element that's not rendered (like in a <symbol> or <defs>). Functions::bugzilla.mozilla.org/show_bug.cgi?id=612118
				} catch (e) {}
			},
